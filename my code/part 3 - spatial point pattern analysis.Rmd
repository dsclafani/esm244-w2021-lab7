...
## converting to spatial point oattern data
...
## Density- making a kernel density plot
...
## it is clear there are hotspots in this data, how can we compare this to complete spatial randomness?

```{r}
#can view this in tmap, - rasterize it
...
```{r}
r <- seq(0, 0.15, by = 0.005) # makes a sequence oveer which we will calculate G(r)
...
using pivot longer to rearrange the data set
```{r}
